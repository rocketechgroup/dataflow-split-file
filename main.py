...
def run(argv=None, save_main_session=True):
    ...
    parser.add_argument(
        '--input',
        dest='input',
        default='gs://rocketech-de-pgcp-sandbox-temp/dataflow-mixed-structure/',
    ...
    with beam.Pipeline() as pipeline:
        partitioned_messages = (
                ...
                | 'Partition' >> beam.Partition(by_message_type, len(message_types))
        )
